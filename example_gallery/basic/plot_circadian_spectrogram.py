...
def plot_circadian_spectrogram():
    fpath = str(DATA_PATH / 'indices') + os.sep  # location of audio files
    ...
    for idx, fname in enumerate(flist):
        ...
        long_wav.append(s)
    # Combine all audio recordings applying a crossfade and compute the
    # spectrogram of
    ...
    # 5-10 h) and
    # dusk (20-21 h), as well as the wind and airplanes sounds at low
    # frequencies.
