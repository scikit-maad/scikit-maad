...
S = -35                 # Sensibility of the microphone -35dBV (SM4) / -38dBV (Audiomoth)  / -12dBV (SM Mini) / -6dBV (SM Mini 2)  
PREANPLIFIER = 26       # Preamplifier gain +26dB (SM4) / +20.8 (Audiomoth 1.2.0) / +20dB (Audiomoth 1.1.0) / +0dB (SM Mini) / +0dB (SM Mini 2)
