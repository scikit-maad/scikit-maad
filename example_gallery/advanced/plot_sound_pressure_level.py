...
def plot_sound_pressure_level():
    ...
    # pressure level of the audio file (dB SPL) as a sound meter level would
    # do.
    ...
    # with date
    # and fullfilename. As the data was collected with a SM4 audio recording
    # device,
    ...
    # One can observe that most of the acoustic energy is between 0-1kHz.
    # Moreover
    ...
    # This is mainly due to the airplanes flying over the forest during the
    # day.
    # One can also observe that the energy of the biophony is really lower than
    # the energy of the low frequency band. The sound pressure level of the
    # biophony
