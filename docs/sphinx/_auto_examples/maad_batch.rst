.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download__auto_examples_maad_batch.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr__auto_examples_maad_batch.py:
...
.. _sphx_glr_download__auto_examples_maad_batch.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: maad_batch.py <maad_batch.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: maad_batch.ipynb <maad_batch.ipynb>`
